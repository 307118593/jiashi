  ...
  <div class="login-box-body">
    ...
    <form action="{{ admin_base_path('auth/login') }}" method="post">
      <div class="form-group has-feedback {!! !$errors->has('username') ?: 'has-error' !!}">
        ...
        <input type="input" class="form-control"  style="background-color: rgba(244, 244, 244, 0.15); "placeholder="{{ trans('admin.username') }}" name="username" value="{{ old('username') }}">
      ...
      <div class="form-group has-feedback {!! !$errors->has('password') ?: 'has-error' !!}">
        ...
        <input type="password" class="form-control" style="background-color: rgba(244, 244, 244, 0.15); "  placeholder="{{ trans('admin.password') }}" name="password">
